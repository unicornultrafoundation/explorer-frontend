...
const ChartArea = ({ id, xScale, yScale, color, data, disableAnimation, ...props }: Props) => {
  ...
  const defaultGradient = {
    startColor: useToken('colors', useColorModeValue('green.100', 'green.400')),
    stopColor: useToken('colors', transparentize(useColorModeValue('green.100', 'green.400'), 0)(theme)),
  };
